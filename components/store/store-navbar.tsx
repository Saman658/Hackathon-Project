    ...
    <nav className={cn("sticky top-0 z-40 border-b border-border bg-surface/80 backdrop-blur-md", className)}>
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <Link href="/store" className="font-semibold text-lg tracking-tight">
            {store.name}
          </Link>
        </div>
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <Link href="/store#products" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">
            Products
          </Link>
